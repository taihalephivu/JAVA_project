...
const AdminReviewManager: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', background: '#fff', borderRadius: 12, boxShadow: '0 4px 24px #0001', padding: 0 }}>
      <div style={{ background: '#e3f0fd', borderTopLeftRadius: 12, borderTopRightRadius: 12, padding: '24px 32px 12px 32px', borderLeft: '6px solid #1976d2', boxShadow: '0 2px 12px #1976d211' }}>
        <h2 style={{ color: '#1976d2', marginBottom: 0, fontSize: 26, fontWeight: 700 }}>Quản lý nhận xét khách hàng</h2>
      </div>
